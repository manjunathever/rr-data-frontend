...
function Searchbar({ onResultsFetched, selectedCountry, cardType }) {
    ...
    useEffect(() => {
        const fetchColumns = async () => {
            ...
            try {
                const response = await axios.post('http://192.168.56.1:5000/get_columns', { file_path: filePath });
    ...
    const fetchSuggestions = async ({ value }) => {
        ...
        try {
            const response = await axios.get('http://192.168.56.1:5000/autosuggest', {
    ...
    const handleSearch = async () => {
        ...
        try {
            const response = await axios.post('http://192.168.56.1:5000/filter', searchData);
